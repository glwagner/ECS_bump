...
### To-do
 ...
 - [x] Qu: Can climlab's RRTMG interface give the spectrally resolved OLR? Like, averaged in its 16 LW bands? That would be cool
  ...
  - EDIT: See [this `climlab` issue I raised](https://github.com/climlab/climlab/issues/137), hopefully it should result in a PR which allows access to the underlying RRTMG_LW fluxes through `climlab`! :) 
  - EDIT: [PR](https://github.com/climlab/climlab/pull/138) submitted! 
